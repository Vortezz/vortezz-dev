    ...
    return (<div className="h-60 w-full bg-vortezz-gray1 flex justify-around text-vortezz-white relative clear-both flex-col md:flex-row">
        ...
        <div className="flex flex-row mx-auto">
            <ul className="my-4 md:mt-16 font-bold">
                ...
                <Link to="/">
                    <li className="font-semibold text-vortezz-gray3 hover:text-vortezz-purple cursor-pointer">{language.BOTTOMBAR.LINKS.CHILDS.ABOUT}</li>
                </Link>
                <Link to="/contact">
                    <li className="font-semibold text-vortezz-gray3 hover:text-vortezz-purple cursor-pointer">{language.BOTTOMBAR.LINKS.CHILDS.CONTACT}</li>
                </Link>
                <Link to="/github" target="_blank">
            ...
            <ul className="my-4 ml-8 md:mt-16 font-bold">
                ...
                <Link to="/status">
                    <li className="font-semibold text-vortezz-gray3 hover:text-vortezz-purple cursor-pointer">{language.BOTTOMBAR.LINKS.CHILDS.STATUS}</li>
                </Link>
                <Link to="/branding">
                    <li className="font-semibold text-vortezz-gray3 hover:text-vortezz-purple cursor-pointer">{language.BOTTOMBAR.LINKS.CHILDS.BRANDING}</li>
                </Link>
                <Link to="/terms">
                    <li className="font-semibold text-vortezz-gray3 hover:text-vortezz-purple cursor-pointer">{language.BOTTOMBAR.LINKS.CHILDS.TERMS}</li>
                </Link>
            </ul>
        </div>
    </div>)
