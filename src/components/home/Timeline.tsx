        ...
        <div className="flex flex-row-reverse md:contents">
            ...
            <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
                <div className="h-[calc(60%)] top-1/2 w-6 flex items-center justify-center">
                    <div className="h-full top-[calc(45%)] absolute w-1 bg-vortezz-white pointer-events-none"></div>
                </div>
            ...
            <div className="col-start-5 col-end-6 mr-10 md:mx-auto relative">
                <div className="h-full w-6 flex items-center justify-center">
                    <div className="h-full w-1 bg-vortezz-white pointer-events-none">
                        <i className='bx bxs-down-arrow text-center mx-auto col-start-5 col-end-6 text-4xl -mt-4 absolute -bottom-6 -right-[calc(0.4rem)]'></i>
                    </div>
                </div>
